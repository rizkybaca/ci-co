...
class Auth extends CI_Controller
{
  ...
  private function _sendEmail($token, $type)
  {
    ...
    $config = [
      ...
      'smtp_user' => 'authority.raadiputra@gmail.com',
    ...
    $this->email->from('authority.raadiputra@gmail.com', 'Authority Raadiputra');
    $this->email->to($this->input->post('email', true));
    if ($type == 'verify') {
      $this->email->subject('Account Verification');
      $this->email->message('Click this link to verify your Raadiputra Apps account :<a href="' . base_url() . 'auth/verify?email=' . $this->input->post('email') . '&token=' . urlencode($token) . '">Activate</a>');
    } else if ($type == 'forgot') {
      $this->email->subject('Reset Password');
      $this->email->message('Click this link to reset your Raadiputra Apps password account : <a href="' . base_url() . 'auth/resetpassword?email=' . $this->input->post('email') . '&token=' . urlencode($token) . '">Reset Password</a>');
    }
